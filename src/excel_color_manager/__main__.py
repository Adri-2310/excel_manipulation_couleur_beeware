"""
Point d'entrée principal de l'application Excel Color Manager.
"""
...
class ExcelColorManager(toga.App):
    """
    Application principale Excel Color Manager.
...
def main():
    ...
    Returns:
        ExcelColorManager: Instance de l'application
    """
    return ExcelColorManager("Excel Color Manager", "com.excelcolormanager.app")
